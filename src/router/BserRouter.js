  ...
  return (
    <div className='container mt-3'>
      <Switch>
        ...
        <Route path='/bser/center'>
          <Center />
        </Route>

        <Route path='/bser/users'>
          <Users />
        </Route>
        <Route path='/bser/user/:id'>
          <User />
        </Route>

        <Route path='/bser/prods'>
          <Prods />
        </Route>
        <Route path='/bser/prod/:id'>
          <Prod />
        </Route>
        ...
        <Route path='/bser/pd/:id'>
          <Pd />
        </Route>

        <Route path='/bser/reload'>
          <Reload />
        </Route>
