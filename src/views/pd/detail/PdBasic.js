    ...
    <Grid container className={classes.root}>
      ...
      <Grid item xs={6}>
        <CusSelectSearch
          ...
          api={categApi}
          queryUrl={
            "&Categ_far=" + pdInfo.categ1?._id + "&level=2&pagesize=200"
          }
      ...
      <Grid item xs={6}>
        ...
        <CusSwitch
          disabled={!modifying}
          checked={pdInfo.is_usable}
          handleSwitch={(val) =>
            setPdInfo((prev) => ({ ...prev, is_usable: val }))
          }
        />
      </Grid>
      <Grid item xs={6}></Grid>
